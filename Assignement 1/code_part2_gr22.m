...
%saveas(gcf,'figure21.png') %Saves the figure as "figure21" in png. format
...
lgd = legend({' ',' ',' ',' ',' ',' ','1 hour','3 hours', ...
        ...
        'Location','southeast', 'NumColumns',2);
title(lgd, "Annual Max depth over time span [mm]")
%saveas(gcf,'figure22.png') %Saves the figure as "figure22" in png. format
%% (5) Th and h
...
hold off
%saveas(gcf,'figure23.png') %Saves the figure as "figure23" in png. format
